...
public class BoardComment extends AppCompatActivity implements View.OnClickListener {
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        if (queryDocumentSnapshots != null) {
                            ...
                            for (DocumentSnapshot snap : queryDocumentSnapshots.getDocuments()) {
                                ...
                                String adderss = String.valueOf(shot.get(Database.address));
                                ...
                                Content data = new Content(documentId, c_name, comment,  Integer.toString(com_pos),board_t,c_photo,num_comment,Latitude,Longitude,price_up,adderss, phone);
    ...
    public void onClick(View v) {
        if (mAuth.getCurrentUser() != null) {//새로 Comment란 컬렉션에 넣어줌
            ...
            data.put(Database.name, comment_p);
